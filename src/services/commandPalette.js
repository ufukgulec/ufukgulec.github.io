...
const COMMANDS = [
    { label: "Hakkýmda", target: "about", icon: "fa-solid fa-user", meta: "Bölüm" },
    ...
    { label: "Yazýlar", target: "blog", icon: "fa-solid fa-pen", meta: "Bölüm" },
    { label: "Hobiler", target: "adventures", icon: "fa-solid fa-mountain-sun", meta: "Bölüm" },
    { label: "Ýletiþim", target: "contact", icon: "fa-solid fa-envelope", meta: "Bölüm" },
    { label: "GitHub Profilini Aç", href: URLs.githubProfile, icon: "fa-brands fa-github", meta: "Harici baðlantý" },
    { label: "LinkedIn Aç", href: "https://www.linkedin.com/in/orhan-ufuk-güleç/", icon: "fa-brands fa-linkedin", meta: "Harici baðlantý" },
    { label: "Medium Aç", href: "https://medium.com/@ufukgulec", icon: "fa-brands fa-medium", meta: "Harici baðlantý" },
    { label: "Özgeçmiþi Ýndir", href: RESUME_URL, icon: "fa-solid fa-file-arrow-down", meta: "Ýþlem" },
    { label: "JSON Üreteç Aracý", href: "./pages/json-generator.html", icon: "fa-solid fa-file-code", meta: "Araç" },
];
    ...
    <div class="command-palette-panel glass" role="dialog" aria-modal="true" aria-label="Komut paleti">
      <div class="command-search">
        ...
        <input
          type="search"
          id="commandSearch"
          placeholder="Bir bölüme veya baðlantýya git..."
          aria-label="Portfolyo komutlarýnda ara"
        />
...
function renderCommands(filter = "") {
    ...
    if (!matches.length) {
        render(html`<div class="command-empty">Eþleþen sonuç bulunamadý</div>`, list);
        return;
    }
