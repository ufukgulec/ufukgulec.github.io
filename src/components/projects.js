    ...
    <div class="project-links">
      ${item.demo
        ? html`<a class="btn btn-primary magnetic ripple" href="${item.demo}" target="_blank" rel="noopener noreferrer">
            <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i> Canlı Önizleme
          </a>`
        : ""}
...
const projectsTemplate = () => html`
  <div class="container">
    <div class="section-heading">
      <p class="section-eyebrow" data-reveal>Öne Çıkan Çalışmalar</p>
      <h2 class="section-title" id="projects-title" data-reveal>
        Yan <span class="gradient-text">Projeler</span>
      </h2>
      <p class="section-subtitle" data-reveal>Ana işimin dışında geliştirip hayata geçirdiğim projeler.</p>
    </div>
